...
const Login = props => {
    ...
    return (
        <motion.div initial="initial" animate="enter" exit="exit" variants={motionVariants} className="form">
            <br />
            <br />
            <Button onClick={props.deauthentice}>Logout</Button>
            <form onSubmit={handleSubmit} id="loginform" className="form-content">
                <div className="container">
                    <h1 style={{ "text-align": "center" }}> Kyçu </h1><br/>
                    <Grid container justify="center" direction="column" spacing={2}>
                        <Grid container justify="center" alignItems="center" direction="column" spacing={3}>
                            <Grid item xs={12}>
                                <TextField style={{"max-width": "300px"}} id="email" label="Email" variant="outlined" onChange={e => setEmail(e.target.value)} value={email} type="email"  className="validate" />
                                <span className="helper-text" data-error="Shënoni një email të vërtetë." data-success=""></span>
                            </Grid>
                            <Grid item xs={12}>
                                <TextField style={{"max-width": "300px"}} id="password" label="Fjalëkalimi" variant="outlined" onChange={e => setPassword(e.target.value)} value={password} type="password" className="validate" />
                        ...
                        <Grid>
                            <Grid container justify="center" spacing={2}>
                                <Grid item>
                                    <Button variant="contained" type="submit" color="primary" disableElevation>Kyçu</Button>
                                </Grid>
                                <Grid item>
                                    <button type="button" className="google-button" onClick="window.location= '/auth/google/callback'" style={{ "cursor": "pointer" }}>
                                        ...
                                        <span className="google-button__text">Kyçu me Google</span>
                                    </button>
                                </Grid>
                            </Grid>
                            <br/>
                            ...
                            <Grid container alignItems="center" justify="center">
                                <Link href="/auth/signup"><a >Regjistrohu</a></Link>
                            </Grid>
                        </Grid>
